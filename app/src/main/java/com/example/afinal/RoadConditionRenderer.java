...
public class RoadConditionRenderer extends DefaultClusterRenderer<MyItem> {

    private final IconGenerator iconGenerator;
    private final Context mContext;

    public RoadConditionRenderer(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {

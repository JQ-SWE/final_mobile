...
public class BusRenderer extends DefaultClusterRenderer<MyItem> {

    private final IconGenerator iconGenerator;
    private final Context mContext;

    public BusRenderer(Context context, GoogleMap map, ClusterManager<MyItem> clusterManager) {
    ...
    protected void onBeforeClusterItemRendered(MyItem item, MarkerOptions markerOptions) {
        ...
        BitmapDescriptor markerDescriptor = BitmapDescriptorFactory.fromResource(R.mipmap.bus);
